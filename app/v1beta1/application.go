...
func CreateOrPatchApplication(ctx context.Context, c cs.AppV1beta1Interface, meta metav1.ObjectMeta, transform func(alert *api.Application) *api.Application, opts metav1.PatchOptions) (*api.Application, kutil.VerbType, error) {
...
func PatchApplication(ctx context.Context, c cs.AppV1beta1Interface, cur *api.Application, transform func(*api.Application) *api.Application, opts metav1.PatchOptions) (*api.Application, kutil.VerbType, error) {
	return PatchApplicationObject(ctx, c, cur, transform(cur.DeepCopy()), opts)
}

func PatchApplicationObject(ctx context.Context, c cs.AppV1beta1Interface, cur, mod *api.Application, opts metav1.PatchOptions) (*api.Application, kutil.VerbType, error) {
...
func TryUpdateApplication(ctx context.Context, c cs.AppV1beta1Interface, meta metav1.ObjectMeta, transform func(*api.Application) *api.Application, opts metav1.UpdateOptions) (result *api.Application, err error) {
	attempt := 0
